      ...
      <form className="panel" onSubmit={save}>
        ...
        <label className="check">
          <input
            ...
            onChange={(e) => setSettings({ ...settings, showPlans: e.target.checked })}
          />
          <span>
            <strong>Exibir planos</strong>
          </span>
        </label>
        <label className="check">
          <input
            ...
            onChange={(e) => setSettings({ ...settings, showSegments: e.target.checked })}
          />
          <span>
            <strong>Exibir segmentos atendidos</strong>
          </span>
        </label>
        <label className="check">
          <input
          ...
          />
          <span>
            <strong>Exibir perguntas frequentes</strong>
          </span>
        </label>
        <div className="panel" style={{ padding: 14 }}>
          <strong>Depoimentos moderados</strong>
          <p className="muted">
            Crie convites e aprove cada avaliação antes de ela aparecer publicamente.
          </p>
