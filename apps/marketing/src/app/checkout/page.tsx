  ...
  async function submit(event: FormEvent) {
    ...
    try {
      const response = await fetch(`${api}/subscriptions/public/checkout`, {
        ...
        body: JSON.stringify({ planSlug, companyName, document, ownerName, email, password, billingType: "PIX" })
      });
